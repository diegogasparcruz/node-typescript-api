...
describe('Rating Service', () => {
  ...
  describe('Get rating based on swell height', () => {
    it('Should get a rating 1 of for less than ankle to knee high swell', () => {
      const rating = defaultRating.getRatingForSwellSize(0.2);
      expect(rating).toBe(1);
    });

    it('Should get a rating 2 of for less than ankle to knee high swell', () => {
      const rating = defaultRating.getRatingForSwellSize(0.6);
      expect(rating).toBe(2);
    });

    it('Should get a rating 3 of for less than ankle to knee high swell', () => {
      const rating = defaultRating.getRatingForSwellSize(1.5);
      expect(rating).toBe(3);
    });

    it('Should get a rating 5 of for less than ankle to knee high swell', () => {
  ...
  describe('Get position based on points location', () => {
    ...
    it('Should get the point based on a wet location', () => {
